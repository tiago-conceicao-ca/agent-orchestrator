...
| [`cahi/`](cahi/SKILL.md) | Architecture and conventions for working on the cahi codebase |
| [`release-notes/`](release-notes/cahi-weekly-release/SKILL.md) | Generate weekly release notes from git history |
