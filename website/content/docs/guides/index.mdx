...
These guides are task-shaped: each one covers a single thing you'd actually want CAHI to do for you, end to end.
...
<Cards>
  ...
  <Card title="CI recovery" description="How CAHI notices red CI and nudges the agent to fix it without you babysitting." href="/docs/guides/ci-recovery" />
  <Card title="Review loop" description="When a reviewer asks for changes, CAHI replays the feedback to the agent." href="/docs/guides/review-loop" />
  ...
  <Card title="Multi-project" description="Run CAHI against several repos from one dashboard." href="/docs/guides/multi-project" />
</Cards>
