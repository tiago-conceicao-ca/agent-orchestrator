...
├── setup                       dashboard, desktop, webhook, slack, discord, composio
...
Runs `cahi-doctor.sh` for shell-level checks, then TypeScript checks (version freshness, plugin resolution, notifier connectivity).
