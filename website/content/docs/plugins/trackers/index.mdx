...
description: Where your issues live. CAHI fetches them, assigns them to sessions, and updates them as work progresses.
---

The **tracker** plugin is how CAHI fetches issues, creates new ones, and links sessions to them. Three trackers ship.
...
1. **Fetch an issue** by id — used by `cahi spawn 42` to build the agent's prompt.
