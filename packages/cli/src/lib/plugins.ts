import type { Agent, OrchestratorConfig, PluginRegistry, SCM } from "@contaazul/cahi-core";
import claudeCodePlugin from "@contaazul/cahi-plugin-agent-claude-code";
import codexPlugin from "@contaazul/cahi-plugin-agent-codex";
import aiderPlugin from "@contaazul/cahi-plugin-agent-aider";
import cursorPlugin from "@contaazul/cahi-plugin-agent-cursor";
import kimicodePlugin from "@contaazul/cahi-plugin-agent-kimicode";
import grokPlugin from "@contaazul/cahi-plugin-agent-grok";
import opencodePlugin from "@contaazul/cahi-plugin-agent-opencode";
import githubSCMPlugin from "@contaazul/cahi-plugin-scm-github";
