...
import { resolveLocalPluginEntrypoint, type InstalledPluginConfig, type PluginSlot } from "@contaazul/cahi-core";
...
export const DEFAULT_REMOTE_MARKETPLACE_REGISTRY_URL =
  "https://raw.githubusercontent.com/contaazul/cahi/main/packages/cli/src/assets/plugin-registry.json";
...
export { normalizeImportedPluginModule } from "@contaazul/cahi-core";
